...
public class SheetListVO {
	...
	/**
	 * @param webHierarchyList the webHierarchyList to set
	 */
	...
	/**
	 * @param configHierarchyList the configHierarchyList to set
	 */
	...
	/**
	 * @param templatesList the templatesList to set
	 */
	...
	//Phase 2
	/**
	 * @param componentPropertiesList the componentPropertiesList to set
	 */
	...
	/**
	 * @param messagingTypeList the messagingTypeList to set
	 */
	...
	/**
	 * @param styleReferenceList the styleReferenceList to set
	 */
	...
	/**
	 * @param invalidAssocationsList the invalidAssocationsList to set
	 */
	...
	/**
	 * @param templateComponentsList the templateComponentsList to set
	 */
	...
	/**
	 * @param kitContentsList the kitContentsList to set
	 */
