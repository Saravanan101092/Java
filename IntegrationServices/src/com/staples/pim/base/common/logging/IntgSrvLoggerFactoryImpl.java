...
public class IntgSrvLoggerFactoryImpl implements IntgSrvLoggerFactory{
	
	public IntgSrvLogger produceLoggerInstance(String name) {
		return new IntgSrvLogger(name);
	}
