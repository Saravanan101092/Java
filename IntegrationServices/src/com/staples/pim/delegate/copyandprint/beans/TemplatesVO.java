...
public class TemplatesVO {
	 ...
	 * @param activeInd
	 */
	public TemplatesVO(String templateId, String templateSku, String itemType, String templateName, String templateDesc, String styleId,
			String templateType, String sellUom, String sellUomQty, String baseUom, String orderQtyList, String minOrdrQty,
			String maxOrdrQty, String paymentReqd, String artWorkProvision, String turnTimeRange, String quickDelvryInd,
	...
	/**
	 * @param pricingStategy
	 *            the pricingStategy to set
	 */
	...
	/**
	 * @param exceptionPagesAllowedInd
	 *            the exceptionPagesAllowedInd to set
	 */
