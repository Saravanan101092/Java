...
public class WholesalerContractFeedBean implements AttributesConstants {
	...
	private String	basicServicesAvailable;
	private String	basicServicesPlusAvailable;
	...
	private String	lorEligiblel;
	private String	lorEligibleForEnrollmentLS1;
	private String	lorEligibleForEnrollmentLS2;
	private String	lorEligibleForEnrollmentLS3;
	...
	public String getBasicServicesAvailable() {

		return basicServicesAvailable;
	}

	public void setBasicServicesAvailable(String basicServicesAvailable) {

		this.basicServicesAvailable = basicServicesAvailable;
	}

	public String getBasicServicesPlusAvailable() {

		return basicServicesPlusAvailable;
	}

	public void setBasicServicesPlusAvailable(String basicServicesPlusAvailable) {

		this.basicServicesPlusAvailable = basicServicesPlusAvailable;
	}
	...
	public String getLorEligiblel() {

		return lorEligiblel;
	}

	public void setLorEligiblel(String lorEligiblel) {

		this.lorEligiblel = lorEligiblel;
	}

	public String getLorEligibleForEnrollmentLS1() {

		return lorEligibleForEnrollmentLS1;
	}

	public void setLorEligibleForEnrollmentLS1(String lorEligibleForEnrollmentLS1) {

		this.lorEligibleForEnrollmentLS1 = lorEligibleForEnrollmentLS1;
	}

	public String getLorEligibleForEnrollmentLS2() {

		return lorEligibleForEnrollmentLS2;
	}

	public void setLorEligibleForEnrollmentLS2(String lorEligibleForEnrollmentLS2) {

		this.lorEligibleForEnrollmentLS2 = lorEligibleForEnrollmentLS2;
	}

	public String getLorEligibleForEnrollmentLS3() {

		return lorEligibleForEnrollmentLS3;
	}

	public void setLorEligibleForEnrollmentLS3(String lorEligibleForEnrollmentLS3) {

		this.lorEligibleForEnrollmentLS3 = lorEligibleForEnrollmentLS3;
	}
	...
	public Map<String, String> getItemAttributeValues() {
		...
		map.put(A0077_NAD, listPrice);
		map.put(A0593, getListPriceEffDate());
		map.put(A0078_NAD, unitCost);
		map.put(A0595, getCostEffDate());
		...
		map.put(A0620_NAD, longDescription);
		...
		map.put(A0599, basicServicesAvailable);
		map.put(A0600, basicServicesPlusAvailable);
		map.put(A0609, lorEligiblel);
		map.put(A0610, lorEligibleForEnrollmentLS1);
		map.put(A0611, lorEligibleForEnrollmentLS2);
		map.put(A0612, lorEligibleForEnrollmentLS3);
		...
		map.put(A0619, isActiveContract());
	...
	private String isActiveContract() {

		String isActiveContract = StringUtils.EMPTY;
