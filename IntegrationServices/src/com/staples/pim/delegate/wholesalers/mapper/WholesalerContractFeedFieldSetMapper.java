...
public class WholesalerContractFeedFieldSetMapper implements FieldSetMapper<WholesalerContractFeedBean> {

	@Override
	public WholesalerContractFeedBean mapFieldSet(FieldSet fieldSet) throws BindException {

		WholesalerContractFeedBean bean = new WholesalerContractFeedBean();
		...
		bean.setBasicServicesAvailable(StringUtils.trimToEmpty(fieldSet.readString("basicServicesAvailable")));
		bean.setBasicServicesPlusAvailable(StringUtils.trimToEmpty(fieldSet.readString("basicServicesPlusAvailable")));
		...
		bean.setLorEligiblel(StringUtils.trimToEmpty(fieldSet.readString("lorEligiblel")));
		bean.setLorEligibleForEnrollmentLS1(StringUtils.trimToEmpty(fieldSet.readString("lorEligibleForEnrollmentLS1")));
		bean.setLorEligibleForEnrollmentLS2(StringUtils.trimToEmpty(fieldSet.readString("lorEligibleForEnrollmentLS2")));
		bean.setLorEligibleForEnrollmentLS3(StringUtils.trimToEmpty(fieldSet.readString("lorEligibleForEnrollmentLS3")));
		return bean;
	}
