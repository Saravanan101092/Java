...
import com.staples.pim.delegate.wholesalers.listenerrunner.RunSchedulerWholesalerDotcom;

public class WholesalerDotcomFeedXMLWriter<WholesalerDotcomFeedBean> implements
		ResourceAwareItemWriterItemStream<WholesalerDotcomFeedBean>, StepExecutionListener,
		SkipListener<WholesalerDotcomFeedBean, Throwable> {
	...
	@Override
	public void write(List<? extends WholesalerDotcomFeedBean> wholesalerDotcomFeedBeanList) throws Exception {

		IntgSrvUtils.printConsole("List Size: " + wholesalerDotcomFeedBeanList.size());
		traceLogger.info("WholesalerDotcomFeedXMLWriter write() List Size: " + wholesalerDotcomFeedBeanList.size());

		for (WholesalerDotcomFeedBean wholesalerDotcomFeedBean : wholesalerDotcomFeedBeanList) {

			com.staples.pim.delegate.wholesalers.model.WholesalerDotcomFeedBean bean = ((com.staples.pim.delegate.wholesalers.model.WholesalerDotcomFeedBean) wholesalerDotcomFeedBean);
	...
	private void setProductDetails(ProductType productTypeItem, String ParentID, String id, String userTypeID,
			com.staples.pim.delegate.wholesalers.model.WholesalerDotcomFeedBean bean) {
	...
	private void setProductDetails(ProductType productTypeItem, String ParentID, String id, String userTypeID, boolean selected,
			boolean referenced, com.staples.pim.delegate.wholesalers.model.WholesalerDotcomFeedBean bean) {
	...
	public void beforeStep(StepExecution stepExecution) {
		...
		this.SkipRoWDetailsFileString = JobParameters.getString(RunSchedulerWholesalerDotcom.WHOLESALER_DOTCOM_FEED_REPORT_FILE);
	}
	...
	@Override
	public void onSkipInProcess(WholesalerDotcomFeedBean wholesalerDotcomFeedBean, Throwable throwable) {

		IntgSrvUtils.printConsole("onSkipInProcess WholesalerDotcomFeedBean: " + wholesalerDotcomFeedBean);
		IntgSrvUtils.printConsole("onSkipInProcess: " + throwable);
		traceLogger.info("WholesalerDotcomFeedXMLWriter onSkipInProcess() : " + String.valueOf(throwable));
		ehfLogger.info(clazzname, "onSkipInProcess", String.valueOf(throwable));
		RunSchedulerWholesalerDotcom.itemTraceLogger.info("WholesalerDotcomFeedXMLWriter onSkipInWrite()" + String.valueOf(throwable));
	}
	...
	public void onSkipInRead(Throwable throwable) {
		...
		try {
			...
			traceLogger.info("WholesalerDotcomFeedXMLWriter onSkipInRead() : " + String.valueOf(throwable));
	...
	public void onSkipInWrite(Throwable throwable1, Throwable throwable2) {
		...
		traceLogger.info("WholesalerDotcomFeedXMLWriter onSkipInWrite() : " + String.valueOf(throwable1));
		ehfLogger.info(clazzname, "onSkipInWrite", throwable1);
		RunSchedulerWholesalerDotcom.itemTraceLogger.info("WholesalerDotcomFeedXMLWriter onSkipInWrite()" + throwable1.getMessage());
	}
}